...
#            nn.AdaptiveMaxPool1d()
        ...
        self.fc_1 = nn.Linear(self.content_dim, 512)
        self.fc_2 = nn.Linear(512, opt.label_size)
    ...
    def forward(self,  content):
        ...
        fc_1 = self.fc_1(reshaped) #64x3
        fc_1 = F.dropout(fc_1,p=0.2)
        logits = self.fc_2(F.leaky_relu(fc_1,0.2))
        return logits

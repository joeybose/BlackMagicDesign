...
#python -m pudb main.py --white --no_pgd_optim --hidden_init --batch_size=128  --namestr="carlini_Text" --LAMBDA=0.01 --carlini_loss --max_iter 1 --max_batches 1 --save_adv_samples 

# Only 1 iteration, all neighbours
python -m pudb main.py --white --no_pgd_optim --hidden_init --batch_size=128  --namestr="carlini_Text" --LAMBDA=0.01 --carlini_loss --max_iter 1 --max_batches 1 --save_adv_samples --nearest_neigh_all

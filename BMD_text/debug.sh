...
python -m pudb main.py --white --no_pgd_optim --hidden_init --batch_size=16  --namestr="carlini_Text" --LAMBDA=0.01 --carlini_loss --max_iter 1 --max_batches 1 --save_adv_samples --prepared_data='dataloader/16_prepared_data.pickle' --diff_nn --temp_decay_schedule 1 --no_parallel
